...
local Main = R3TH:addPage("Main", 10709782154)
...
--------------------------------------------------------------------------------------MAIN----------------------------------------------------------------------------------------
AutoFarmContainer1, AutoFarmText1 = AutoFarm:addParagraph("Auto Farm not working?", "Go to Settings > Layout > Preferred Layout and select Vertical Scroll.")
